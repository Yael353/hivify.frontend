    ...
    <footer className="bg-black text-white/70 py-12 ">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 justify-around">
          ...
          <div className="text-center md:text-start md:col-span-2 flex flex-col md:flex-row justify-around gap-8">
            <div className="py-2">
          ...
          <div className="flex justify-center md:justify-center items-center md:items-center">
